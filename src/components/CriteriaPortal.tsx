    ...
    items: [
      ...
      { 
        ...
        pdfFiles: [
          ...
          { name: 'Ecopy Certificate 21-22.pdf', url: '/assets/Copy of Certificate 21-22.pdf' },
          { name: 'List of teachers 20-21.pdf', url: '/assets/2020-21-Copy of List_of_Teacher.pdf' },
          { name: 'Ecopy Certificate 20-21.pdf', url: '/assets/2020-21Copy of Copy_Of_certificatedvv.pdf' },
          { name: 'List of teachers 19-20.pdf', url: '/assets/Copy of List of Faculty2019-20.pdf' },
          { name: 'Ecopy Certificate 19-20.pdf', url: '/assets/Copy of Certificate_2019-20.pdf' },
          { name: 'List of teachers 18-19.pdf', url: '/assets/18-19-List_Of_Teacher.pdf' },
          { name: 'Ecopy Certificate 18-19.pdf', url: '/assets/18-19-copy_Of_Certificate.pdf' },
      ...
      { 
        id: 'Criteria 7',
        pdfFiles: [
          { name: 'Any other relevant proof.pdf', url: '/assets/Quality certificate.pdf' },
          { name: 'Bills for purchase of equipment under this metric.pdf', url: '/assets/7.1.2 Bills for purchase of equipment under this metric.pdf' },
          { name: 'Geotagged Photographs of facilities.pdf', url: '/assets/7.1.2 Geotagged Photographs of facilities.pdf' },
          { name: 'Permission Document for connecting to grid.pdf', url: '/assets/7.1.2 Permission Document for connecting to grid.pdf' },
          { name: 'Bills for purchase of equipment.pdf', url: '/assets/7.1.4 Bills for purchase of equipment.pdf' },
          { name: 'Geotagged Photos of facilities.pdf', url: '/assets/7.1.4 Geotagged Photos of facilities.pdf' },
          { name: 'Green Audit report on water conservation facilties on campus.pdf', url: '/assets/7.1.4 Green Audit report on water conservation facilties on campus.pdf' },
          { name: 'Water conservation policy document.pdf', url: '/assets/7.1.4 water conservation policy document.pdf' },
